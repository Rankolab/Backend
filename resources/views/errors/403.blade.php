...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 px-4">
    <div class="text-center">
        <h1 class="text-9xl font-bold text-green-500 dark:text-green-400">403</h1>
        <h2 class="text-4xl font-bold text-gray-800 dark:text-white mt-4">Access Denied</h2>
        <p class="text-lg text-gray-600 dark:text-gray-300 mt-4">Sorry, you don't have permission to access this page.</p>
        <div class="mt-8">
