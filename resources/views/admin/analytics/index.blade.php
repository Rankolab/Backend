...
@push("styles")
{{-- Chart.js is likely included globally in layouts.app, no extra CSS needed unless customizing --}}
@endpush
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            ...
            <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white">{{ number_format($totalUsers) }}</p>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            ...
            <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white">{{ number_format($totalWebsites) }}</p>
        </div>

        <!-- Widget 3: Active Licenses -->
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Active Licenses</h3>
            <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white">{{ number_format($activeLicenses) }}</p>
        </div>

        <!-- Widget 4: API Calls (Last 24h) -->
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">API Calls (24h)</h3>
            <p class="mt-1 text-3xl font-semibold text-gray-900 dark:text-white">{{ number_format($apiCallsLast24h) }}</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
        ...
        <ul class="list-disc list-inside space-y-2 text-sm">
            <li><a href="{{ route("admin.users.index") }}" class="text-indigo-600 hover:underline dark:text-indigo-400">User Management Report</a></li>
            <li><a href="{{ route("admin.websites.index") }}" class="text-indigo-600 hover:underline dark:text-indigo-400">Website Activity Report</a></li>
            <li><a href="{{ route("admin.licenses.index") }}" class="text-indigo-600 hover:underline dark:text-indigo-400">License Usage Report</a></li>
            <li><a href="{{ route("admin.api.logs") }}" class="text-indigo-600 hover:underline dark:text-indigo-400">API Call Log Details</a></li>
            <li><a href="{{ route("admin.api.analytics") }}" class="text-indigo-600 hover:underline dark:text-indigo-400">API Performance Analytics</a></li>
...
@push("scripts")
{{-- Ensure Chart.js is loaded (likely in layouts.app) --}}
<script>
