                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-4 mb-md-0">
                            <div class="stat-card bg-gradient-success text-white h-100">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="text-white stretched-link" href="{{ route('admin.websites.index') }}">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="stat-card bg-gradient-info text-white h-100">
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h2>{{ $stats['publishedArticles'] ?? 0 }}</h2>
                                    </div>
                                    <div class="icon">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="text-white stretched-link" href="{{ route("admin.blogs.index") }}"iew Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="stat-card bg-gradient-warning text-white h-100">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="text-white stretched-link" href="{{ route('admin.licenses.index') }}">View Details</a>
                                    <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>User {{ $i }}</td>
                                    <td>{{ ['Login', 'Content Update', 'License Purchase', 'Profile Update', 'Website Added'][$i-1] }}</td>
                                    <td>{{ now()->subHours($i)->format('H:i') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
