...
{
    /**
     * Display the main API management dashboard.
     */
    public function index()
    {
        // You can pass some summary data here if needed
    ...
    public function updateKeys(Request $request)
    {
        ...
        return redirect()->route("admin.api.keys")->with("success", "API key updated successfully"); // Corrected route name
    }
